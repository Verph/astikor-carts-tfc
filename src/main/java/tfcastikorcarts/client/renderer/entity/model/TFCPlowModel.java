...
public class TFCPlowModel extends CartModel<TFCPlowEntity>
{
    ...
    @Override
    public void setupAnim(final TFCPlowEntity entity, final float delta, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float pitch)
    {
